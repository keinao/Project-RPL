               ...
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         <div class="mb-3">
                              ...
                              <input type="number" class="form-control w-50" id="nis" placeholder="Masukkan NISN" min="1"
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="ekstrakurikuler" name="ekstrakurikuler">
                                   ...
                                   <option value="Sanggar Tari">Sanggar Tari</option>
                                   <option value="Sains Club">Sains Club</option>
                                   <option value="Olahraga">Olahraga</option>
                              </select>
                         </div>
                         <div class="mb-3">
                              <label for="email" class="form-label">Email Orang Tua/Wali siswa</label>
                              <input type="email" class="form-control w-50" id="email" placeholder="Masukkan Alamat Email"
