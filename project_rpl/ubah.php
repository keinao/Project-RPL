...
<body background="bg4.png">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Admin Data Siswa SD Tunas Bangsa</a>
               ...
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="ekstrakurikuler" name="ekstrakurikuler">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Ekstrakurikuler--------------------------------------------</option>
                                   <option value="Pramuka" <?php if ($siswa['ekstrakurikuler'] == 'Pramuka') { ?>
                                        selected='' <?php } ?>>Pramuka</option>
                                   <option value="English Club"
                                        <?php if ($siswa['ekstrakurikuler'] == 'English Club') { ?> selected=''
                                        <?php } ?>>English Club</option>
                                   <option value="Drum Band" <?php if ($siswa['ekstrakurikuler'] == 'Drum Band') { ?>
                                        selected='' <?php } ?>>Drum Band</option>
                                   <option value="Sanggar Tari"
                                        <?php if ($siswa['ekstrakurikuler'] == 'Sanggar Tari') { ?> selected=''
                                        <?php } ?>>Sanggar Tari</option>
                                   <option value="Sains Club" <?php if ($siswa['ekstrakurikuler'] == 'Sains Club') { ?>
                                        selected='' <?php } ?>>Sains Club</option>
                                   <option value="Olahraga" <?php if ($siswa['ekstrakurikuler'] == 'Olahraga') { ?> selected=''
                                        <?php } ?>>Olahraga</option>
                              </select>
                         </div>
                         <div class="mb-3">
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    ...
                    Alamat: Jl. Pendidikan No. 10, Kota Masa Depan
                    </p>
               </div>
          </div>
     </div>
